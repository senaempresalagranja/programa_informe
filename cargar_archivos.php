...
">
	<tr ><td colspan="12" class="text-center"><h3 class="help-block"> LISTADO MAESTRO DE INFORMES</h3></td></tr>
...
while ($fila=mysqli_fetch_row($resource)) {
  ...
  ?>
	...
	<tr>
		...
		<td><a href="pages/admin/documentos/documentos/<?php echo $fila[5] ?>" class="icon icon-download btn form-control"></a></td>
