...
$usuario = "bootcamp_informe_maestro"; //El usuario que tiene mysql por defecto
$contrasenha = "informe_maestro"; //La contraseña del usuario que utilizaremos
$BD = "bootcamp_informe_maestro"; //El nombre de la base de datos
