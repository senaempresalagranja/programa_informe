...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<h3 class="help-block text-center">Ingresar Informe</h3>
				<hr>
			</div>
...
<option value="<?php echo $fila[0] ?>"><?php echo "$fila[1]" ?></option>
	...
	<?php 
					 ...
					 ?>
						...
						<div class="col-md-3">
				<span class="help-block">Nombre del Informe</span>
	<input type="text" class="form-control" id="nombre_documento" name="nombre_documento">
		...
		<div class="row">
			<br>
					...
					<div class="col-md-3">
				<span class="help-block">Tipo de Informe</span>
				...
				<div class="col-md-3">
				<span class="help-block">Codigo del Informe</span>
...
<option value="<?php echo $fila[0] ?>"><?php echo "$fila[1]" ?></option>
	...
	<?php 
			...
			<div class="col-md-3">
				<span class="help-block">Anexar Informe</span>
...
if (validar_id_area()==true && validar_id_proceso()==true && validar_id_procedimiento()==true && validar_nombre_documento()==true && validar_Id_tipo_doc()==true && validar_Codigo_documento()==true && validar_version()==true && validar_Fecha_doc()==true && validar_Id_Responsable()==true) {
...
$("#contenedor").load("validar_documentos1.php",{documento:documento})
}
...
var btnac=document.getElementById("btnac").style.display="block";
	$("#contenedor").load("actualizar_registro.php",{id_registro_actualizar:id_registro_actualizar});
...
$("#contenedor").load("Eliminar_registro.php",{id_registro:id_registro,nombre_mag:nombre_mag});
...
$("#contenedor_argumentos_registrados").load("cargar_argumentos.php",{criterio:criterio});
}
...
if (validar_id_area()==true && validar_id_proceso()==true && validar_id_procedimiento()==true && validar_nombre_documento()==true && validar_Id_tipo_doc()==true && validar_Codigo_documento()==true && validar_version()==true && validar_Fecha_doc()==true && validar_Id_Responsable()==true && validar_documento()==true) {


var documento=document.getElementById('documento').files[0].name;

$("#contenedor").load("validar_documentos.php",{documento:documento})
